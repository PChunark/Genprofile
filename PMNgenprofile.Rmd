---
title : "The Pak Mun Hydro Power Plant (PMN) generation profile"
...
```{r pmngenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
pmnprofile2021 <-
  read_excel("rawdata/PMN_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r pmngenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
pmnprofile2022 <-
  read_excel("rawdata/PMN_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_pmnminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  pmnprofile2022 %>% 
...
```{r plot_pmnmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  pmnprofile2021 %>% 
...
```{r plot_pmnmaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  pmnprofile2022 %>% 
