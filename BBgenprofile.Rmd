---
title: "The Bhumibol Hydro Power Plant (BB) generation profile"
...
```{r bbgenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
bbprofile2021 <-
...
```
```{r bbgenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
bbprofile2022 <-
...
```{r plot_bbminegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  bbprofile2021 %>% 
...
```{r plot_bbminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  bbprofile2022 %>% 
...
```{r plot_bbmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  bbprofile2021 %>% 
...
```{r plot_bbmaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  bbprofile2022 %>% 
