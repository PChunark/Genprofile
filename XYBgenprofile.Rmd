---
title: "The Xayaburi Hydro Power Plant (XYB@EDL) generation profile"
...
```{r xybgenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
xybprofile2021 <-
...
```
```{r xybgenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
xybprofile2022 <-
...
```{r plot_xybminegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  xybprofile2021 %>% 
...
```{r plot_xybminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  xybprofile2022 %>% 
...
```{r plot_xybmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  xybprofile2021 %>% 
...
```{r plot_xybmaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  xybprofile2022 %>% 
