---
title : "The Rajjaprabha Hydro Power Plant (RPB) generation profile"
...
```{r rpbgenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
rpbprofile2021 <-
  read_excel("rawdata/RPB_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r rpbgenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
rpbprofile2022 <-
  read_excel("rawdata/RPB_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_rpbminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  rpbprofile2022 %>% 
...
```{r plot_rpbmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  rpbprofile2021 %>% 
...
```{r plot_rpbmaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  rpbprofile2022 %>% 
