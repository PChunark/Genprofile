---
title : "The Bang Lang Hydro Power Plant (BLG) generation profile"
...
```{r blggenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
blgprofile2021 <-
  read_excel("rawdata/BLG_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r blggenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
blgprofile2022 <-
  read_excel("rawdata/BLG_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_blgminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  blgprofile2022 %>% 
...
```{r plot_blgmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  blgprofile2021 %>% 
