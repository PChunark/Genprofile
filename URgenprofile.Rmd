---
title : "The Ubol Ratana Hydro Power Plant (UR) generation profile"
...
```{r urgenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
urprofile2021 <-
  read_excel("rawdata/UR_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r urgenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
urprofile2022 <-
  read_excel("rawdata/UR_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_urminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  urprofile2022 %>% 
...
```{r plot_urmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  urprofile2021 %>% 
...
```{r plot_urmaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  urprofile2022 %>% 
