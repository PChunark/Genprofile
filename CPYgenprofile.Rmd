---
title : "The Chao Phraya Hydro Power Plant (CPY) generation profile"
...
```{r cpygenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
cpyprofile2021 <-
  read_excel("rawdata/CPY_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r cpygenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
cpyprofile2022 <-
  read_excel("rawdata/CPY_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_cpyminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  cpyprofile2022 %>% 
...
```{r plot_cpymaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  cpyprofile2021 %>% 
...
```{r plot_cpymaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  cpyprofile2022 %>% 
