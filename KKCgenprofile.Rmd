---
title : "The Kaeng Krachan Hydro Power Plant (KKC) generation profile"
...
```{r kkcgenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
kkcprofile2021 <-
  read_excel("rawdata/KKC_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r kkcgenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
kkcprofile2022 <-
  read_excel("rawdata/KKC_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_kkcminegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  kkcprofile2022 %>% 
...
```{r plot_kkcmaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  kkcprofile2021 %>% 
...
```{r plot_kkcmaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  kkcprofile2022 %>% 
