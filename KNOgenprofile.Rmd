---
title : "The Khwae Noi Hydro Power Plant (KNO) generation profile"
...
```{r knogenprofile2021, echo=FALSE, message=FALSE, warning=FALSE}
knoprofile2021 <-
  read_excel("rawdata/KNO_01012021_31122021.xlsx") %>% 
  rename_all(tolower) %>% 
...
```
```{r knogenprofile2022, echo=FALSE, message=FALSE, warning=FALSE}
knoprofile2022 <-
  read_excel("rawdata/KNO_01012022_31122022.xlsx") %>% 
  rename_all(tolower) %>% 
  mutate(timestamp = as.POSIXct(timestamp, format = "%d-%b-%Y %H:%M", tz = "UTC"),
         date = as.Date(timestamp, format = "%d-%b-%Y"),
         time = format(as.POSIXct(timestamp), format = "%H:%M:%S"), 
...
```{r plot_knominegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  knoprofile2022 %>% 
...
```{r plot_knomaxegtnetgen2021, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  knoprofile2021 %>% 
...
```{r plot_knomaxegtnetgen2022, echo=FALSE, warning=FALSE, message=FALSE}
ggplotly(
  knoprofile2022 %>% 
